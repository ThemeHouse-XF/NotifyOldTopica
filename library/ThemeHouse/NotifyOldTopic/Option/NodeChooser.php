 ...
 */
class ThemeHouse_NotifyOldTopic_Option_NodeChooser extends XenForo_Option_NodeChooser
{
    ...
    {
        return self::_render('th_option_select_notifyoldthreads', $view, $fieldPrefix, $preparedOption,
            $canEdit);
