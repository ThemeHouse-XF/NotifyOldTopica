...
class ThemeHouse_NotifyOldTopic_Option_NotifyOldThreads
{
    ...
    public static function renderOption(XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit)
    {
        ...
        return $view->createTemplateObject('th_option_template_notifyoldthreads',
            array(
    ...
    {
        return XenForo_Application::get('options')->get('th_notifyOldThreads_' . $key);
    } /* END get */
}